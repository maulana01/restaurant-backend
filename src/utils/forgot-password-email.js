...
<body style="font-family: Arial, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e6e6e6; background-color: #f9f9f9;">
    ...
    <p><a href="https://dashboard.apisansco.my.id/reset-password/${token}" style="display: inline-block; padding: 10px 20px; background-color: #4CAF50; color: #ffffff; text-decoration: none; border-radius: 4px;">Reset Password</a></p>
    <p>Terima kasih.</p>
  </div>
</body>
</html>`;
